...
public class Config {
     ...
     * 包名
     */
    public static final String PackageName = "com.zznorth.tianji002";
     ...
     */
    public final static String AccountId = "tianji002";

    /**
     * 产品ID（天玑壹号，天玑贰号）
     */
    public final static String ProductId = "tianji002";
    /**
     * 键名--是否点击了更新提示框
     */
